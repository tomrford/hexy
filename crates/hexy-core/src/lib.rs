...
pub use io::{
    AutoFormat, BinaryWriteOptions, CCodeOutput, CCodeWordType, CCodeWriteOptions,
    DEFAULT_SREC_BYTES_PER_LINE, FileIoError, HexAsciiWriteOptions, SRecordType,
    SRecordWriteOptions, detect_format, parse_auto, parse_binary, parse_hex_ascii, parse_srec,
    write_binary, write_c_code, write_hex_ascii, write_srec,
};
pub use io::{
